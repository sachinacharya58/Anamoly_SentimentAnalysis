...
class DataEngine:
	def __init__(self, history_to_use, data_granularity_minutes, is_save_dict, is_load_dict, dict_path, min_volume_filter, is_test, future_bars_for_testing, volatility_filter, stocks_list, data_source):
		...
		self.stocks_file_path = self.directory_path + f"/stocks/stocks.txt"
		self.stocks_list = []
		#print (self.stocks_file_path)
...
#stock_prices = yf.download("MSFT",start=startdate)
#supriver.load_stocks_from_file()
#supriver.collect_data_for_all_tickers()
#supriver.get_data("AAPL")
